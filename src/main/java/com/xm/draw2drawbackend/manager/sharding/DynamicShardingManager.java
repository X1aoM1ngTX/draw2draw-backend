package com.xm.draw2drawbackend.manager.sharding;
...
public class DynamicShardingManager {
    ...
    private void updateShardingTableNodes() {
        ...
        // d2d.picture_112321321,d2d.picture_1123213123
        String newActualDataNodes = tableNames.stream()
                .map(tableName -> "d2d." + tableName) // 确保前缀合法
    ...
    public void createSpacePictureTable(Space space) {
        // 仅为旗舰版团队空间创建分表
        if (space.getSpaceType() == SpaceTypeEnum.TEAM.getValue() && space.getSpaceLevel() == SpaceLevelEnum.MAX.getValue()) {
